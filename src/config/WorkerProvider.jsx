...
export const WorkerProvider = ({ children }) => {
    ...
    const N8N_WEBHOOK_URL = import.meta.env.VITE_N8N_WEBHOOK_URL || 'https://n8n.srv853599.hstgr.cloud/webhook/6dde1fd9-4b59-4639-b0ba-3474f164617d';

    const API_KEY = import.meta.env.VITE_API_KEY || 'MI_SECRETO_API_KEY';
        ...
        try {
            ...
            if (storedData) {
                ...
                if (Array.isArray(parsedData)) {
                    ...
                    console.warn('Stored data is not an array, clearing localStorage');
                    localStorage.removeItem('data-n8n');
                }
            }
        } catch (error) {
