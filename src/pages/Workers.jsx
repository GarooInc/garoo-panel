        ...
        try {
            ...
            addSection("Datos Personales", [
                ...
                [
                    ...
                    worker.pretencion_salarial
                        ? `Q${worker.pretencion_salarial.toLocaleString()}`
                        : "N/A",
                ],
            ...
            if (worker.educacion && worker.educacion.length > 0) {
                ...
                addSection("Educación", [
                    ...
                    [
                        "Período",
                        `${education.periodo?.inicio || "N/A"} - ${education.periodo?.fin || "N/A"}`,
                    ],
                ]);
            }
            ...
            if (worker.experiencia && worker.experiencia.length > 0) {
                ...
                addSection("Experiencia Laboral", [
                    ...
                    [
                        "Período",
                        `${experience.fecha_ingreso?.mes || "N/A"}/${experience.fecha_ingreso?.año || "N/A"} - ${experience.fecha_egreso?.mes || "N/A"}/${experience.fecha_egreso?.año || "N/A"}`,
                    ],
                    [
                        "Salario Final",
                        experience.salario_final
                            ? `Q${experience.salario_final.toLocaleString()}`
                            : "N/A",
                    ],
            ...
            if (
                worker.referencias_laborales &&
                worker.referencias_laborales.length > 0
            ) {
            ...
            if (
                worker.referencias_personales &&
                worker.referencias_personales.length > 0
            ) {
            ...
            // Guardar el PDF
            doc.save(
                `CV_${(worker.nombre_completo || "trabajador").replace(/[^a-z0-9]/gi, "_")}.pdf`,
            );
        } catch (error) {
        ...
        try {
            ...
            if (typeof date === "number") {
                ...
                return isNaN(jsDate.getTime())
                    ? "N/A"
                    : jsDate.toLocaleDateString("es-GT");
            }
